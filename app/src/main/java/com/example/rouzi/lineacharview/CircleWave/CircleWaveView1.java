...
public class CircleWaveView1 extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#51b0e3");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#5ecff7");
    ...
    public CircleWaveView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CircleWaveView1(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setBorder(int width, int color) {
        if (mBorderPaint == null) {
            ...
            mBorderPaint.setStyle(Style.FILL_AND_STROKE);
        }
    ...
    private void createShader() {
        ...
        float[] positions = new float[]{0f, 0.4f, 1f};
        LinearGradient lg = new LinearGradient(0,getHeight(),0,getWaterLevelRatio()*getHeight(),
                colors, positions, Shader.TileMode.CLAMP);
        wavePaint.setShader(lg);
    ...
    private void initAnimation() {
        ...
        ObjectAnimator waterLevelAnim = ObjectAnimator.ofFloat(
                this, "waterLevelRatio", 0f, getWaterLevelRatio());
